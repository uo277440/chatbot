...
const Forum = () => {
    ...
    useEffect(() => {
        ...
        const initializeWebSocket = () => {
            ...
            websocket.current = new WebSocket('wss://48163e47-6126-4fd1-90c5-dasds8f9c0943df84.e1-eu-north-azure.choreoapps.dev/choreo-apis/chatbottfg/backend/v1/ws/forums/');
